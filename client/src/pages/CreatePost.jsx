...
const CreatePost = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if(form.prompt && form.photo) {
      ...
      alert('Please generate a prompt and generate an image')
    }
  };
    ...
    <section className="max-w-7xl mx-auto">
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[16px] max-w-[500px]">
          Create imaginative and visually stunning images generated by DALL-E AI and share them to the community
        </p>
      </div>
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        ...
        <div className="mt-10">
          ...
          <button className="mt-3 text-white bg-[#6469ff] font-medium rounded-md text-sm w-full 
